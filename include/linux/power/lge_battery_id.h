...
enum {
	...
	BATT_ID_RESISTOR_NC		= 280,
	BATT_ID_RESISTOR_PD		= 300,
#endif
};
...
#if defined (CONFIG_MACH_MSM8917_B6_JCM_JP) || defined(CONFIG_MACH_MSM8917_B6_LGU_KR) || defined(CONFIG_MACH_MSM8917_B6_LAO_COM) || defined(CONFIG_MACH_MSM8917_B6_OPEN_SK)
