...
#if defined (CONFIG_MACH_SDM450_CV5A_KT_KR) || defined (CONFIG_MACH_SDM450_CV5A_LGU_KR) || defined (CONFIG_MACH_SDM450_CV5A_SKT_KR) || defined (CONFIG_MACH_SDM450_CV5A_LGU_LDU) || defined (CONFIG_MACH_SDM450_CV7A_KR) || defined (CONFIG_MACH_SDM450_CV7A_LGU_LDU)
static uint32_t gpio_fault = 0;    // DRV8838_SLEEP_N_Pin, MSM GPIO 97
#endif
