...
// 19.02.13 Complete to check final setting values from CV7A MP SAS_11390
...
#if defined(CONFIG_MACH_SDM450_MH4_LAO_COM) || defined(CONFIG_MACH_SDM450_MH4_LAO_COM_NONAB)
// Each operator use different initcode value
// 18.11.21 Apply HW tuning value 
// 18.12.04 Apply HW tuning value
