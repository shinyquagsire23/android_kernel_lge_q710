...
#ifndef LGE_TOUCH_FT8736_H
#define LGE_TOUCH_FT8736_H

#define FT8736_ESD_SKIP_WHILE_TOUCH_ON
#define FTS_CTL_IIC
...
struct ft8736_touch_info {
	...
	u32 button_cnt:3;
	u32 palm_bit:16;
	struct ft8736_touch_data data[10];
	/* debug info */
	struct ft8736_touch_debug debug;
} __packed;
...
#define GESTURE_ON_CTRL			(0xD0)
#define SWIPE_DIST_THRESHOLD_CTRL	(0x8E)
#define SWIPE_RATIO_THRESHOLD_CTRL	(0x92)
#define SWIPE_TIME_MIN_H_CTRL		(0x93)
#define SWIPE_TIME_MIN_L_CTRL		(0x94)
#define SWIPE_TIME_MAX_H_CTRL		(0x95)
#define SWIPE_TIME_MAX_L_CTRL		(0x96)
#define SWIPE_WRONG_DIRECTION_THD_H_CTRL	(0x97)
#define SWIPE_WRONG_DIRECTION_THD_L_CTRL	(0x98)

#define SWIPE_ACTIVE_AREA_X1_H_CTRL	(0xD5)
#define SWIPE_ACTIVE_AREA_X1_L_CTRL	(0xD6)
#define SWIPE_ACTIVE_AREA_Y1_H_CTRL	(0xD7)
#define SWIPE_ACTIVE_AREA_Y1_L_CTRL	(0xD8)
#define SWIPE_ACTIVE_AREA_X2_H_CTRL	(0xD9)
#define SWIPE_ACTIVE_AREA_X2_L_CTRL	(0xDA)
#define SWIPE_ACTIVE_AREA_Y2_H_CTRL	(0xDB)
#define SWIPE_ACTIVE_AREA_Y2_L_CTRL	(0xDC)

#define SWIPE_START_AREA_X1_H_CTRL		(0xF0)
#define SWIPE_START_AREA_X1_L_CTRL		(0xF1)
#define SWIPE_START_AREA_Y1_H_CTRL		(0xF2)
#define SWIPE_START_AREA_Y1_L_CTRL		(0xF3)
#define SWIPE_START_AREA_X2_H_CTRL		(0xF4)
#define SWIPE_START_AREA_X2_L_CTRL		(0xF5)
#define SWIPE_START_AREA_Y2_H_CTRL		(0xF6)
#define SWIPE_START_AREA_Y2_L_CTRL		(0xF7)
#define SWIPE_INIT_RATIO_CHK_DIST_CTRL	(0xF8)
#define SWIPE_INIT_RATIO_THD_CTRL		(0xF9)

#define FTS_META_REGS			3
#define FTS_ONE_TCH_LEN			8//6
...
#if 0
struct ft8736_version {
	u8 build : 4;
	u8 major : 4;
	u8 minor;
};

struct ft8736_ic_info {
	struct ft8736_version version;
	u8 product_id[8];
	u8 image_version[2];
...
struct ft8736_data {
	struct device *dev;
	struct kobject kobj;
	struct ft8736_touch_info info;
	struct ft8736_ic_info ic_info;
//	struct ft8736_asc_info asc;	/* ASC */
...
#ifdef CONFIG_LGD_FT8736_FHD_VIDEO_LCD_PANEL
...
static inline struct ft8736_data *to_ft8736_data(struct device *dev)
{
	return (struct ft8736_data *)touch_get_device(to_touch_core(dev));
}

static inline struct ft8736_data *to_ft8736_data_from_kobj(struct kobject *kobj)
{
	return (struct ft8736_data *)container_of(kobj,
			struct ft8736_data, kobj);
}
...
int ft8736_tc_driving(struct device *dev, int mode);
...
static inline int ft8736_read_value(struct device *dev,
					u16 addr, u32 *value)
{
	return ft8736_reg_read(dev, addr, value, sizeof(*value));
}

static inline int ft8736_write_value(struct device *dev,
					 u16 addr, u32 value)
{
	return ft8736_reg_write(dev, addr, &value, sizeof(value));
}

//void ft8736_xfer_msg_ready(struct device *dev, u8 msg_cnt);

extern int get_smartcover_status(void);
extern int ft8736_lpwg_set(struct device *dev);
#endif /* LGE_TOUCH_FT8736_H */
