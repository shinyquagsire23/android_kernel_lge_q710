...
#define NOISE_MITIGATION_CTRL_REG		(d->f54.dsc.control_base + 6) // 0x01 : Disable Noise Mitigation Mode
...
/* ESD Detect Control Register using Delta */
#define MAX_POSITIVE_SATURATED_DELTA	(d->f51.dsc.data_base + 122)
#define MAX_NEGATIVE_SATURATED_DELTA	(d->f51.dsc.data_base + 124)
#define MAX_FRAME_CNT					(d->f51.dsc.data_base + 126)
...
struct synaptics_f51_reg {
	...
	u8 lpwg_adc_fF_reg3;
	u8 lpwg_adc_fF_reg4;
	u16 esd_saturated_max;
	u16 esd_saturated_min;
	u16 esd_frame_cnt;
};
