        ...
        size_t count, loff_t *offset)
{
...
#ifdef READ_IRQ_MODIFY
        ret = wait_event_interruptible_timeout(pn547_dev->read_wq, do_reading|GET_GPIO(pn547_dev->irq_gpio), msecs_to_jiffies(NFC_TIMEOUT_MS)); //NFC-7548
#else
    ...
    {
#ifdef READ_IRQ_MODIFY
        ret = wait_event_interruptible(pn547_dev->read_wq, do_reading|GET_GPIO(pn547_dev->irq_gpio)); //NFC-7548
#else
