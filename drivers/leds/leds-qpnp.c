...
static const struct patrn_data lg_led_patterns[ID_LED_MAX] = {
	...
	[ID_LED_ON_160ms_IN_12000ms] = {.brightness_val = 4, .period_in_msec = 12000, .repeat = 0},
	...
	[ID_LED_ON_235ms_IN_60000ms] = {.brightness_val = 1, .period_in_msec = 60000, .repeat = 0},
};
#endif
	...
	const char *buf, size_t count)
{
	...
	switch (pattern_id) {
		...
		case ID_AAT_LED_TEST:
			led->ptrn_id = ID_LED_ON_500ms_IN_1000ms;
			break;
		case ID_TMUS_MISSED_NOTI:
		case ID_TMUS_URGENT_CALL_MISSED_NOTI:
			led->ptrn_id = ID_LED_ON_235ms_IN_60000ms;
			break;
#endif
		default:
